"""
Django settings for busservices project.
...
SECRET_KEY = 'mfeete58)u4jy(u+h5$4@$a!5q4z@ly7fo7%oggl)!0zt--vq%'
...
WSGI_APPLICATION = 'busservices.wsgi.application'
